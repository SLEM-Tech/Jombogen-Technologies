...
const RefundPolicy = () => {
	...
	return (
		<div className='text-gray-600 space-y-6 text-xs sm:text-sm'>
			<p>
				At jombogenJombogen Technologies Limited, we strive for 100% accuracy in every
			...
			<section>
				...
				<ul className='list-disc pl-5 mt-2 space-y-2'>
					...
					<li>
						...
						our error, jombogen Import covers the return shipping. For all other
			...
			<section>
				...
				<p>
					At jombogen Import, we act as your dedicated procurement agent. While
